...
# results.binned_distances_vs_responses_baseline(measurement='z score response')
...
# results.binned_distances_vs_responses_interictal(measurement='z score response')
