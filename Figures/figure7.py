...
pplot.plot_bar_with_points(data=[pj.flattenOnce(proximal_responses), pj.flattenOnce(distal_responses)], points=False,
                           paired=False, bar=True, colors=['#db5aac', '#dbd25a'], edgecolor='black', lw = 1.25,
                           x_tick_labels=['proximal', 'distal'], y_label='z score (to baseline)',
                           title='avg z score response', ylims=[0, 0.25])
...
# %% 5.2) PLOTTING of average responses +/- sem across distance to targets bins - PROXIMAL
