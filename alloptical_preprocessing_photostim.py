...
comments = '10 cells x 4 groups; 5mW per cell; 250ms-stim multi_interleaved (prot. #3); 9 sz events; trial starts just after and ends mid sz'
naparms_loc = '/photostim/2021-02-02_PS18_photostim_011/'  # make sure to include '/' at the end to indicate the child directory
exp_type = 'post 4ap 2p all optical'  # use 'post' and '4ap' in the description to create the appropriate post4ap exp object
analysis_save_path = '/home/pshah/mnt/qnap/Analysis/2021-02-02/PS18/'
