...
trial = 't-023'  # note that %s magic command in the code below will be using these trials listed here
exp_type = '1p photostim, pre 4ap'
comments = '1 shot (probably 20 shots at 25Hz, 50% power on dial)'
...
aoplot.plot_lfp_1pstim_avg_trace(expobj, individual_traces=True, x_axis='time')
